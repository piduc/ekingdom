...
<head>
	<?php 
		...
		$id = ($_GET['id']);
			$Upit = "SELECT proposed, time, attacker, defender, region FROM laws WHERE id='$id'";
	...
	<div class="glavni">
		<div class="levi">
			...
			<div class="srednji">
				...
				<div class="lawdiv">
						<?php echo "On date ".$time."<br>The ruler king of ".$attacker.": ".$proposed." had attacked \"region ".$region."\" which belongs to ".$defender."<br>The war began!"; ?>
